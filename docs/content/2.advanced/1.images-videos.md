...
The `image`, `video` and `news` namespaces are added to your sitemap by default, allowing you to configure
...
To opt-out of this behavior, you can set the `discoverImages` and `discoverVideos` config to `false` respectively.
