...
relatedPages:
  - path: /docs/sitemap/releases/v8
    title: Nuxt Sitemap v8.0.0
  - path: /docs/sitemap/releases/v6
    title: Nuxt Sitemap v6.0.0
  - path: /docs/site-config/releases/v3
    title: Nuxt Site Config v3.0.0
---
...
Please use the `cacheMaxAgeSeconds` as it's a clearer config.
