...
::note
If you already installed `@nuxtjs/seo`, you already have Nuxt Sitemap. Install `@nuxtjs/sitemap` directly only when you want the sitemap module without the rest of the Nuxt SEO bundle.
::
