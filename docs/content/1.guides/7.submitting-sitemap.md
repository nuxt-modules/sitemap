...
**Deprecation of sitemap pinging.** In January 2024, Google [deprecated the "ping" endpoint](https://developers.google.com/search/blog/2023/06/sitemaps-lastmod-ping) (e.g., `http://www.google.com/ping?sitemap=...`).
...
When submitting a sitemap for the first time you may see "Error". This is because Google previously
