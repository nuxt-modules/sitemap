...
description: Parse and traverse sitemap documents with the runtime-neutral sitemapd package.
relatedPages:
  - path: /docs/sitemap/advanced/performance
    title: Performance
---

The canonical parser is published separately as `sitemapd`. It works in
Node, browsers, Bun, and workerd without importing Nuxt or H3.
